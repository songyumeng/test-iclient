...
<body>
  ...
  <script>
    ...
    function runQuery() {
      const dataServiceUrl = "__DATA_SERVICE_URL__";
      const datasourceName = "__DATASOURCE_NAME__";
      const datasetName = "__DATASET_NAME__";
      const attributeFilter = "__ATTRIBUTE_FILTER__";
      ...
      const sqlParam = new mapboxgl.supermap.GetFeaturesBySQLParameters({
        queryParameter: { name: qpName, attributeFilter: attributeFilter },
        datasetNames
      });
